...
//            chrono::high_resolution_clock::time_point t2b= chrono::high_resolution_clock::now();
...
//            chrono::high_resolution_clock::time_point t2c= chrono::high_resolution_clock::now();
//            Table_p2r[allocatedPtr]=lookupIdx;
//            chrono::high_resolution_clock::time_point t2d= chrono::high_resolution_clock::now();
//            //update load
//            if(loadLogFlag==1){
//                Table_load[gc]=make_pair(Table_load.find(gc-1)->second.first,Table_load.find(gc-1)->second.second+size);
//            }
//        chrono::high_resolution_clock::time_point t2= chrono::high_resolution_clock::now();
//        auto duration = chrono::duration_cast<chrono::microseconds>( t2 - t1 ).count();
//        auto duration2b = chrono::duration_cast<chrono::microseconds>( t2b - t1 ).count();
//        auto duration2c = chrono::duration_cast<chrono::microseconds>( t2c - t1 ).count();
//        auto duration2d = chrono::duration_cast<chrono::microseconds>( t2d - t1 ).count();
//        cout<<gc<<" condition M2 "<<duration<<' '<<duration2b<<' '<<duration2c<<' '<<duration2d<<endl;
//
//        }
...
//                //cout<<gc<<" condition F2 "<<duration<<endl;
//            }else{
//                Table_r2Ver.find(resp_rIdx)->second.Occupied =0;
//                chrono::high_resolution_clock::time_point t2= chrono::high_resolution_clock::now();
//                auto duration = chrono::duration_cast<chrono::microseconds>( t2 - t1 ).count();
//                //cout<<gc<<" condition F4 "<<duration<<endl;
//            }
        }else{
            //update load
            if(loadLogFlag==1){
